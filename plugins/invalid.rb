...
#
# Ybot show picture that your argumets are invalid
# Usage: Ybot invalid
#

invalid_list = ["http://s3.amazonaws.com/kym-assets/photos/images/newsfeed/000/007/517/my_hat_is_made_of_eggs.jpg",
...
puts invalid_list[rand(invalid_list.length)]